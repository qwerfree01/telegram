    ...
    if form.validate_on_submit():
    	...
    	if "stop" == stop:
    		...
    		if len(number) == 11 and len(phone) == 11:
	    	       ...
	    	       return render_template_string('''
	    	       <center><br>
	    	       <h3><font color="green">تم الحجز بنجاح سوف  يتم التواصل بك </font></h3><br><br><b>
	    	       <h4><i>انسخ الكود واذهب الي بيانات الحجز للتحقق </i></h4><br><br>
	    	       {{id}}
	    	       <br><br><br><br>
	    	       <form action="/">
...
def data():
        if request.method=="GET":
        	...
        	if code in js[number] and number in js:
        		...
        		<h4>اضغط هنا للالغاء الحجز</h4>
        		<br>
        		<button type="submit" name="delete" value={{number}} name="name">الغاء الحجز</button>
